...
set(BUILD_VERSION ${BLENDER_VERSION_BUILD})
...
if(CPACK_OVERRIDE_PACKAGENAME)
  ...
  set(CPACK_PACKAGE_FILE_NAME ${PROJECT_NAME_LOWER}-${MAJOR_VERSION}.${MINOR_VERSION}.${PATCH_VERSION}.${BUILD_VERSION}-${PACKAGE_ARCH})
endif()
